<template>
    <nav id="sidebar">
        <div id="sidebar_content">
            ...
            <ul id="side_items">
                <li v-if="tipoAcesso != 'aluno'" id="inicio" class="side-item" @click="gotoDashboard">
                ...
                <li v-if="tipoAcesso != 'aluno'" id="configuracoes" class="side-item" @click="gotoConfiguracoes">
                ...
                <li v-if="tipoAcesso != 'aluno'" id="pessoas" class="side-item" @click="gotoPessoasSetores">
                ...
                <li v-if="tipoAcesso != 'aluno'" id="indicadores" class="side-item" @click="gotoIndicadores()">
                ...
                <li id="conversas" class="side-item" @click="gotoConversas()">
                ...
                <li v-if="tipoAcesso != 'aluno'" id="relatorios" class="side-item" @click="gotoRelatorios()">
...
export default {
    ...
    methods: {
        ...
        gotoPessoasSetores() {
            this.$router.push('/pessoas-setores');
        },
        gotoIndicadores() {
